...
ada_gd = AdalineGD(n_iter=100, eta=0.25, random_state=10)
ada_gd.fit(X_std, y)
...
ada_sgd = AdalineSGD(n_iter=100, eta=0.25, random_state=10)
ada_sgd.fit(X_std, y)
...
ada_mb_sgd = AdalineSGD(n_iter=100, eta=0.25, random_state=10)
