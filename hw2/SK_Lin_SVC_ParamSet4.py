...
def plot_scalability_results(results_df, output_dir='./Param_Set_4'):
...
if __name__ == "__main__":
    ...
    outs_dir_name = "Param_Set_4"
    if not (os.path.exists(outs_dir_name) and os.path.isdir(outs_dir_name)):
        os.mkdir("Param_Set_4")
    
    results_dir = os.path.join(current_dir, "Param_Set_4")
