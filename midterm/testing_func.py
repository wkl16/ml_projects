...
def Task_4_xz_v1_generate(startx1, startx2, endx1, endx2, num_points):
    x1s = np.random.uniform(low=startx1, high=endx1, size=(num_points * 21, 1))
    # x2s = np.random.uniform(low=startx2, high=endx2, size=(num_points, 1))
    ...
    for i in range(num_points):
        cool_x1, cool_x2 = Task_4_xz_v1(x1s[i])
...
def Task_4_xz_v2_generate(startx1, startx2, endx1, endx2, num_points):
    x1s = np.random.uniform(low=startx1, high=endx1, size=(num_points, 1))
    # x2s = np.random.uniform(low=startx2, high=endx2, size=(num_points, 1))
...
if __name__ == "__main__":
    ...
    xs, zs, cool_xs, cool_zs = Task_4_xz_v2_generate(-3, 0, 3, 15, 100)
